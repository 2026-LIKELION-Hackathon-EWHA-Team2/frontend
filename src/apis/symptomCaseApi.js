...
export const createSymptomCaseApi = (formData) =>
  axiosInstance
    .post('/selfsymptoms/symptom-cases/', formData, {
...
export const getSymptomCaseListApi = () =>
  axiosInstance.get('/selfsymptoms/symptom-cases/').then((res) => res.data);

// 증상 케이스 상세 조회
// GET /api/selfsymptoms/symptom-cases/{symptom_case_id}/
export const getSymptomCaseDetailApi = (symptomCaseId) =>
  axiosInstance.get(`/selfsymptoms/symptom-cases/${symptomCaseId}/`).then((res) => res.data);