...
export const MOCK_CONSULT_PATIENTS = [
  {
    ...
    ingredients: ['Botulimun Toxin Type A', 'Lidocaine HCl', 'Hyaluronic Acid'],
    doctorNote: '시술 후 예상 범위 내의 붓기 홍반이 있으며, 2~3일 경과 관찰이 필요합니다.',
    registeredByHospital: 'Tokyo Medical',
    confirmedByHospital: 'ABC Beauty Clinic',
  },
  {
    id: 'p2',
    caseId: '2026-0625',
    ...
    ingredients: ['Lidocaine HCl'],
    doctorNote: '레이저 시술 직후 나타날 수 있는 경미한 붓기로 판단되며, 냉찜질 후 경과 관찰이 필요합니다.',
    registeredByHospital: 'Tokyo Medical',
    confirmedByHospital: 'ABC Beauty Clinic',
  },
  {
    ...
    procedureAt: '2026.04.20 11:00',
    symptomLevel: '보통',
    symptomDesc: '흉터 부위가 간지럽고 살짝 붉습니다.',
    sideEffects: ['가려움'],
    aiSummary: '환자는 여드름 흉터 레이저 치료 후 양쪽 볼에 가려움과 경미한 홍조를 호소합니다.',
    procedureName: '여드름 흉터 레이저',
    procedureArea: '양쪽 볼',
    procedureDate: '2026.04.20',
    ingredients: ['Lidocaine HCl', 'Hyaluronic Acid'],
    doctorNote: '레이저 치료 후 흔히 나타나는 일시적 가려움으로 보이며, 보습 관리와 경과 관찰을 권장합니다.',
    registeredByHospital: 'Busan Skin Center',
    confirmedByHospital: 'ABC Beauty Clinic',
  },
  {
    id: 'p4',
    ...
    procedureAt: '2026.07.20 09:40',
    symptomLevel: '심함',
    symptomDesc: '리프팅 시술 부위 통증이 지속됩니다.',
    sideEffects: ['통증'],
    aiSummary: '환자는 리프팅 시술 후 턱선 부위 통증을 호소하며 강도는 심한 편입니다.',
    procedureName: '리프팅(울쎄라)',
    procedureArea: '턱선',
    procedureDate: '2026.07.20',
    ingredients: ['Lidocaine HCl'],
    doctorNote: '시술 부위 통증이 예상 범위보다 다소 강하게 나타나고 있어, 진통제 복용 후 48시간 이내 재확인이 필요합니다.',
    registeredByHospital: 'Gangnam Dermatology',
    confirmedByHospital: 'ABC Beauty Clinic',
  },
  {
    id: 'p5',
    ...
    procedureName: '입술 필러',
    procedureArea: '입술',
    procedureDate: '2026.07.05',
    ingredients: ['Hyaluronic Acid', 'Lidocaine HCl'],
    doctorNote: '시술 직후 나타나는 정상 범위의 붓기로 판단되며, 별도 조치 없이 경과 관찰만으로 충분합니다.',
    registeredByHospital: 'Miso Aesthetic clinic',
    confirmedByHospital: 'ABC Beauty Clinic',
  },
  {
    id: 'p6',
    ...
    ingredients: ['Lidocaine HCl'],
    doctorNote: '고강도 초음파 시술 후 흔히 동반되는 근육통 및 붓기로 보이며, 3~5일 경과 관찰을 권장합니다.',
    registeredByHospital: 'Cheongdam Clinic',
    confirmedByHospital: 'ABC Beauty Clinic',
  },
  {
    id: 'p7',
    ...
    procedureName: '색소 레이저',
    procedureArea: '오른쪽 뺨',
    procedureDate: '2026.04.05',
    ingredients: ['Lidocaine HCl'],
    doctorNote: '레이저 시술 후 회복 과정에서 나타날 수 있는 경미한 가려움으로, 특이 조치 없이 관찰이 필요합니다.',
    registeredByHospital: 'Cheongdam Clinic',
    confirmedByHospital: 'ABC Beauty Clinic',
  },
  {
    ...
    procedureName: '턱 보톡스',
    procedureArea: '턱',
    procedureDate: '2026.07.14',
    ingredients: ['Botulimun Toxin Type A'],
    doctorNote: '특이 부작용 없이 정상적인 회복 과정을 보이고 있어 별도 조치가 필요하지 않습니다.',
    registeredByHospital: 'Osaka Aesthetic Clinic',
    confirmedByHospital: 'ABC Beauty Clinic',
  },
];
